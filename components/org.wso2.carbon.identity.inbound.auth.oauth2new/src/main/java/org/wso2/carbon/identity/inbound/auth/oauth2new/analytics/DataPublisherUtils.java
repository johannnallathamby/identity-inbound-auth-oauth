...
public class DataPublisherUtils {
    ...
    public static String[] getTenantDomains(String spTenantDomain, String userTenantDomain) {
        ...
        if (StringUtils.isBlank(userTenantDomain) || userTenantDomain.equalsIgnoreCase(DataPublisherConstants
                .NOT_AVAILABLE)) {
            return new String[]{spTenantDomain};
        }
        if (StringUtils.isBlank(spTenantDomain) || userTenantDomain.equalsIgnoreCase(DataPublisherConstants
                .NOT_AVAILABLE)) {
