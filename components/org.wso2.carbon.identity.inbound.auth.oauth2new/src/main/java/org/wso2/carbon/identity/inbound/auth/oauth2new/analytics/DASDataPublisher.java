...
public class DASDataPublisher extends OAuth2EventInterceptor {
    ...
    // TODO: move this implementation to framework, remove ir from here and update framework dependency version
    public String getName() {
        return this.getClass().getSimpleName();
    }

    // TODO: implement all OAuth2 related data publishing here
