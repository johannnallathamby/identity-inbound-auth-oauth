...
public class SimpleContext implements Context {
   ...
   // @Override
    ...
    @Override
    public void setValidateClientProvidedNewSessionId(boolean b) {
    ...
    @Override
    public void setMapperContextRootRedirectEnabled(boolean b) {
    ...
    @Override
    public void setMapperDirectoryRedirectEnabled(boolean b) {
    ...
    @Override
    public void setUseRelativeRedirects(boolean b) {
