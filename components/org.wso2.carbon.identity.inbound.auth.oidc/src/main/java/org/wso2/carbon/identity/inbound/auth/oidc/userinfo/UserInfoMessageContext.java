...
/*
 * Message context that holds information about the user info request to the userinfo endpoint
 */
public class UserInfoMessageContext<T1 extends Serializable, T2 extends Serializable> extends OAuth2MessageContext {
    ...
    public UserInfoMessageContext(UserInfoRequest request, Map<T1, T2> parameters) {
